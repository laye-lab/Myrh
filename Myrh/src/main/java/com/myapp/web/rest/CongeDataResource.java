...
import com.myapp.repository.CongeDataRepository;
...
/**
 * REST controller for managing {@link com.myapp.domain.CongeData}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CongeDataResource {
    ...
    private static final String ENTITY_NAME = "congeData";
