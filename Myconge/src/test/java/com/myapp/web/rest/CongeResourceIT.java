...
import com.myapp.repository.CongeRepository;
...
public class CongeResourceIT {
    ...
    private static final LocalDate DEFAULT_DATE_RETOUR_EFFECTIVE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_RETOUR_EFFECTIVE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Conge createEntity(EntityManager em) {
        Conge conge = new Conge()
            ...
            .dateRetourEffective(DEFAULT_DATE_RETOUR_EFFECTIVE);
        return conge;
    }
    /**
    ...
    public static Conge createUpdatedEntity(EntityManager em) {
        Conge conge = new Conge()
            ...
            .dateRetourEffective(UPDATED_DATE_RETOUR_EFFECTIVE);
        return conge;
    }
    ...
    public void createConge() throws Exception {
        ...
        assertThat(testConge.getDateRetourEffective()).isEqualTo(DEFAULT_DATE_RETOUR_EFFECTIVE);
    }
    ...
    @Test
    @Transactional
    public void checkDateRetourEffectiveIsRequired() throws Exception {
        int databaseSizeBeforeTest = congeRepository.findAll().size();
        // set the field null
        conge.setDateRetourEffective(null);
    ...
    public void getAllConges() throws Exception {
        ...
        restCongeMockMvc.perform(get("/api/conges?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateRetourEffective").value(hasItem(DEFAULT_DATE_RETOUR_EFFECTIVE.toString())));
    }
    ...
    public void getConge() throws Exception {
        ...
        restCongeMockMvc.perform(get("/api/conges/{id}", conge.getId()))
            ...
            .andExpect(jsonPath("$.dateRetourEffective").value(DEFAULT_DATE_RETOUR_EFFECTIVE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateConge() throws Exception {
        ...
        assertThat(testConge.getDateRetourEffective()).isEqualTo(UPDATED_DATE_RETOUR_EFFECTIVE);
    }
