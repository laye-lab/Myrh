...
import com.myapp.repository.TrackerRepository;
...
/**
 * REST controller for managing {@link com.myapp.domain.Tracker}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TrackerResource {
    ...
    private static final String ENTITY_NAME = "myCongeTracker";
